...
In [the previous post](https://open-ebike.github.io/devlog/2025/09/11/register-and-generate-data-using-a-bosch-powered-ebike.html) we learned how to generate data using a Bosch-powered eBike. Now let's continue with the registration for data access.
...
Additionally, we create a public client application

* client application name: test-confidential
* login URL: http://localhost:4200
* redirect URL: http://localhost:4200
* confidential client: not
