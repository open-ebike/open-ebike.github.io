...
Now let's [load all registrations a user has performed](https://github.com/open-ebike/open-ebike-frontend/issues/6). To do so we need to
...
To simplify the navigation we add links from a registered eBike to the eBike details page.  
